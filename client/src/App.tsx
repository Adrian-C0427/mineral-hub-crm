...
export function App() {
  ...
  if (!user) {
    // Public routes reachable while signed out. "/" is the marketing site;
    // deep links (e.g. /deals) still land on the login form, and sign-up
    // remains invite-code-gated on the Login page itself.
    return (
      <Suspense fallback={<Spinner label="Loading…" />}>
        <Routes>
